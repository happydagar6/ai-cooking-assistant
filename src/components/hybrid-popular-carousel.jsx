...
import { Star, Globe, Clock, ChefHat, Filter } from 'lucide-react';
import { useHybridPopular } from '@/hooks/use-hybrid-recommendations';
import { Button } from '@/components/ui/button';

/**
 * HybridPopularCarousel Component
 * Displays popular/highly-rated recipes blending internal and external sources
 * Stable data - updates less frequently
 * Shows ratings from both sources
 */
export function HybridPopularCarousel({ limit = 12, includeWeb = true }) {
  const { data: recipes = [], isLoading } = useHybridPopular(limit, includeWeb);
