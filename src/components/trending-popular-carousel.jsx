...
import { useTrendingRecipes, useTrackInteraction } from '@/hooks/use-recommendations';
    ...
    <Link href={`/cook/${recipe.id}`} onClick={handleClick}>
      <Card className="flex-shrink-0 w-64 sm:w-72 hover:shadow-xl transition-all duration-300 border-0 bg-white snap-start group">
        <CardContent className="p-4">
          {/* Optimized Recipe Image with lazy loading */}
          <div className="relative mb-3 rounded-lg overflow-hidden h-40">
            ...
            {/* Stats Badge */}
            <div className="absolute top-2 right-2 bg-white/90 backdrop-blur-sm rounded-full px-2 py-1 flex items-center gap-1 shadow-md">
